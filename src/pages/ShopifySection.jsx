    ...
    <div className="md:flex bg-[#F9FAFB] justify-between py-20 mb-10 ">
      <div className="md:w-1/2  md:mx-20 mx-6 ">
        ...
        <div
          ...
          data-aos-offset="300"
          data-aos-easing="ease-in-sine"
          className="flex text-yellow-400  gap-1 py-6"
        >
        ...
        <p
          ...
          data-aos-offset="300"
          data-aos-easing="ease-in-sine"
          className="font-medium text-black text-3xl md:w-96"
        >
        ...
        <div className="flex py-6 justify-between md:w-96 mb-5">
          ...
          <div className="flex gap-4">
            <button className="rounded-full p-3 border border-blue-100 bg-white">
              {" "}
              <ArrowLeftIcon className="h-4 text-blue-700" />
            </button>
            <button className="rounded-full p-3 border border-blue-100 bg-white">
              {" "}
              <ArrowRightIcon className="h-4 text-blue-700" />
            </button>
          </div>
        </div>
      </div>
